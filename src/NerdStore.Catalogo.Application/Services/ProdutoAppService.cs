...
namespace NerdStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        ...
        public async Task AdicionarProduto(ProdutoViewModel produtoViewModel)
        {
            ...
            _produtoRepository.Register(produto);
        ...
        {
            return _mapper.Map<IEnumerable<CategoriaViewModel>>(await _produtoRepository.GetListCategory());
        }

        public async Task<IEnumerable<ProdutoViewModel>> ObterPorCategoria(int codigo)
        {
            return _mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.GetByCategoria(codigo));
        }
        ...
        {
            return _mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.GetList());
        }
